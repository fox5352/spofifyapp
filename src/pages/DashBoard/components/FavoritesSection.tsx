...
export default function FavoritesSection() {
  ...
  return (
    ...
    >
      ...
      <h1 className="flex justify-start w-full md:max-w-[90%] text-4xl font-bold py-1 pl-2 bg-gradient-to-r from-[--ac-one] via-violet-500 to-purple-500 bg-clip-text text-transparent">
        Favorites
      </h1>
