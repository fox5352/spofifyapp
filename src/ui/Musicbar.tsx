          ...
          <div className="flex flex-col items-center max-w-32 md:max-w-none w-full">
            ...
            <div className="flex flex-col items-center max-w-96 min-w-44 w-full">
              ...
              <nav className="flex gap-2 mb-1">
                <button
                  className="text-3xl md:text-4xl text-[--text-two] rounded-full duration-200 ease-in-out bg-indigo-500 hover:scale-90 transition-all"
                  onClick={playPrev}
                ...
                <button
                  className="text-3xl md:text-4xl text-[--text-two] rounded-full duration-200 ease-in-out bg-gradient-to-r from-indigo-500 to-purple-500 hover:scale-90 transition-all"
