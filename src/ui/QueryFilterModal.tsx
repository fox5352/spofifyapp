  ...
  return (
    ...
    >
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div
          ref={modalRef}
          className="relative text-[--text] bg-[--bg-two] rounded-lg shadow"
        >
          {/* Modal header */}
          <div className="flex items-center justify-between p-4 md:p-5 rounded-t">
            <h3 className="text-2xl font-semibold bg-gradient-to-r from-[--ac-one] via-[--ac-two] to-[--ac-three] bg-clip-text text-transparent">
              Filter Menu
            </h3>
            <button
              type="button"
              className="text-inherit bg-transparent hover:bg-gradient-to-r from-[--ac-one] to-[--ac-three] hover:text-zinc-950 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center duration-200 transition-all ease-linear"
          ...
          <div className="w-full max-w-xl h-1 mx-auto bg-gradient-to-r from-[--ac-one] via-[--ac-two] to-[--ac-three] rounded-full" />
          {/* Modal body */}
